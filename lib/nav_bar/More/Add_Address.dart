...
class _AddAdressState extends State<AddAdress> {
  ...
  void initState() {
    ...
    latitudeTapped=widget.lat;
    LongeitudeTapped=widget.longi;
    print(latitudeTapped);
    print(LongeitudeTapped);
    super.initState();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<dynamic>(
                            ...
                            value: country,
                            items: countryList.map((list) => DropdownMenuItem(
                                child: Text(list.name),
                                value: list.id.toString())).toList(),
                            onChanged: (value) {
                              setState(() {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<dynamic>(
                            ...
                            value: state,
                            items: stateList.map((statelist) => DropdownMenuItem(
                                child: Text(statelist.name),
                                value: statelist.id.toString())).toList(),
                            onChanged: (value) {
                              setState(() {
                                state = value;
                                print('state');
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                                ...
                                autocorrect: true,
                                decoration: KDecoration.copyWith(
                                    hintText: '${AppController.strings.Building}'))
                          ],
                        )),
                    Padding(
                        padding: EdgeInsets.all(10),
                    ...
                    child:   Container(
                        ...
                        child: GoogleMap(
                          initialCameraPosition: CameraPosition(
                              target: LatLng(latitudeTapped, LongeitudeTapped), zoom: 5),
                          onTap: _handleTap,
